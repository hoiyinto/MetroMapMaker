...
public class AppGUI {
    ...
    protected FlowPane aboutBar;
    protected FlowPane undoRedoBar;
    ...
    private void initTopToolbar(AppTemplate app) {
        ...
        saveAsButton = initChildButton(fileToolbar,	SAVEAS_ICON.toString(),	    SAVEAS_TOOLTIP.toString(),	true);
	...
	// AND NOW SETUP THEIR EVENT HANDLERS
        ...
        infoButton = initChildButton(aboutBar,	INFO_ICON.toString(),	    INFO_TOOLTIP.toString(),	true); 
        
        undoRedoBar=new FlowPane();
        undoButton = initChildButton(undoRedoBar,	UNDO_ICON.toString(),	    UNDO_TOOLTIP.toString(),	true); 
        redoButton = initChildButton(undoRedoBar,	REDO_ICON.toString(),	    REDO_TOOLTIP.toString(),	true);
       
        undoRedoBar.setMinWidth(1300);
        topToolbarPane.getChildren().add(fileToolbar);
        topToolbarPane.getChildren().add(undoRedoBar);
        topToolbarPane.getChildren().add(aboutBar);     
    }
   ...
   /**
	...
	topToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
        ...
        undoRedoBar.getStyleClass().add(CLASS_BORDERED_PANE);
